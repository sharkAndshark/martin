...
| `/{source1},…,{sourceN}/{z}/{x}/{y}`     | [Composite Source Tiles](../configuration-file/sources-composite.md) |
| `/sprite/{spriteID}[@2x].{json,png}`     | [Sprite sources](../configuration-file/sources-sprites.md)           |
| `/sdf_sprite/{spriteID}[@2x].{json,png}` | [SDF Sprite sources](../configuration-file/sources-sprites.md)       |
| `/font/{font}/{start}-{end}`             | [Font source](../configuration-file/sources-fonts.md)                |
| `/font/{font1},…,{fontN}/{start}-{end}`  | [Composite Font source](../configuration-file/sources-fonts.md)      |
