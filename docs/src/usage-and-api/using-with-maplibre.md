...
vector source URL. You should also specify a `source-layer` property. For [Table Sources](../configuration-file/sources-pg-tables.md) it
...
You can also combine multiple sources into one source with [Composite Sources](../configuration-file/sources-composite.md). Each source in a
